...
def module_scroll_frame(num1, num2):
  ...
  if num1 == 1:
    if num2 == 1:
      ...
      CTkToolTip(test, delay=0.5, message=lang_load_set("joiner_bypassms")) 
      ...
      CTkToolTip(test, delay=0.5, message=lang_load_set("joiner_bypasscap"))
      ...
      CTkToolTip(test, delay=0.5, message=lang_load_set("joiner_deletems")) 
      ...
      CTkToolTip(test, delay=0.5, message=lang_load_set("joiner_warning_serverid")) 
    ...
    if num2 == 2:
      ...
      CTkToolTip(test, delay=0.5, message=lang_load_set("nmspam_allping")) 
      ...
      CTkToolTip(test, delay=0.5, message=lang_load_set("nmspam_allch")) 
      ...
      CTkToolTip(test, delay=0.5, message=lang_load_set("nmspam_rdstring")) 
      ...
      CTkToolTip(test, delay=0.5, message=lang_load_set("nmspam_ratefixer"))
      ...
      CTkToolTip(test, delay=0.5, message=lang_load_set("nmspam_randomconvert"))
